...
typedef NS_ENUM(NSUInteger, ViewPagerComponent) {
    ...
    ViewPagerTabsView,
    ViewPagerContent,
    ViewPagerNormalTextColor,
    ViewPagerSeletedTextColor,
};

@protocol ViewPagerDataSource;
@protocol ViewPagerDelegate;

@interface PageScrollerView : UIView
...
- (UIView *)viewPager:(PageScrollerView *)viewPager contentViewForTabAtIndex:(NSUInteger)index;
...
- (void)viewPager:(PageScrollerView *)viewPager didChangeTabToIndex:(NSUInteger)index;
 ...
 */
- (UIColor *)viewPager:(PageScrollerView *)viewPager colorForComponent:(ViewPagerComponent)component withDefault:(UIColor *)color;
